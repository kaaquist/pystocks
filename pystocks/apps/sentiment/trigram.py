...
class Trigram:
    """
    Class take from: http://code.activestate.com/recipes/326576/
    And slightly modified to handle tweets inputed as string.
...
def test():
    tweet = Trigram('Casper is trying to make this stuff work.')
