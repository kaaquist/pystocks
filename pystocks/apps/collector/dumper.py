...
COMPANY_TO_TWEET_VIEW = 'http://localhost:5984/tweets/_design/views/_view/company_to_tweet'
"""URL to CouchDB view."""
...
def _write_company(company, tweets):
	...
	filename = filename_for_company(company)
...
def _sort_docs(docs):
	"""Extract the needed information from the full CouchDB documents and return the results as a list."""
	result = {}
	for tweet in docs:
